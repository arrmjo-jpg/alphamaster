...
return [
    ...
    'client_url' => [
        'address' => 'لا يمكن استخدام :attribute: :problem',
        'entry' => 'لا يمكن استخدام العنصر :position من :attribute: :problem',
        'list' => 'يجب أن يكون :attribute قائمة عناوين.',
        'problem' => [
            'not_text' => 'ليس نصًا.',
            'not_absolute' => 'يجب أن يكون عنوانًا كاملًا يتضمن البروتوكول والمضيف، دون مسافات.',
            'too_long' => 'يتجاوز 2048 حرفًا.',
            'scheme' => 'البروتوكول غير مقبول. استخدم https (أو http خارج بيئة الإنتاج)، أو مخطط تطبيق بصيغة النطاق المعكوس لتطبيق أصلي.',
            'fragment' => 'يجب ألا يحتوي على جزء (#).',
            'userinfo' => 'يجب ألا يحتوي على اسم مستخدم أو كلمة مرور.',
            'wildcard' => 'يجب ألا يحتوي على حرف بدل (*)، فالعناوين تُطابق حرفيًا.',
            'insecure' => 'يجب أن يستخدم https في بيئة الإنتاج.',
            'loopback' => 'يجب ألا يشير في بيئة الإنتاج إلى localhost أو إلى عنوان استرجاع محلي.',
            'duplicate' => 'مُدرج أكثر من مرة.',
        ],
    ],
    ...
    'custom' => [
        ...
        'cdn_item' => [
            'empty' => 'لا يمكن أن يكون العنصر فارغًا.',
            'too_long' => 'هذا العنصر أطول مما يقبله مزوّد CDN.',
            'characters' => 'لا يحتوي وسم التخزين المؤقت إلا على حروف وأرقام والمحارف . _ : / -.',
            'host' => 'هذا ليس اسم نطاق.',
            'not_absolute' => 'اكتب العنوان كاملًا بدءًا بـ https://.',
            'scheme' => 'لا تُحذف إلا عناوين http وhttps.',
            'userinfo' => 'لا يمكن أن يحتوي عنوان الحذف على بيانات دخول.',
            'fragment' => 'لا يمكن أن يحتوي عنوان الحذف على جزء # لأن الحافة لا تراه.',
            'no_items' => 'حذف كل شيء لا يأخذ عناصر.',
            'invalid' => 'أحد العناصر لا يمكن حذفه.',
        ],
        'preferred_locale' => [
        ...
        'label' => [
            'unusable' => 'يجب أن تحتوي تسمية الدور على حرف واحد على الأقل يصلح لتوليد معرّف.',
        ],
        'ai_model' => [
            'credential' => 'معرّف النموذج يبدو كمفتاح API. أدخل اسم النموذج هنا، والمفتاح في حقل مفتاح API.',
        ],
        'name' => [
