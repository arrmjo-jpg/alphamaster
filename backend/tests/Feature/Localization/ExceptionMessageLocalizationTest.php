...
test('every key this scope introduced exists in both dictionaries', function (): void {
    ...
    // AI providers to the control centre. A refused credential rotation then gained a
    // second message, for when nothing was checked because the configuration it is
    // verified against was incomplete.
    expect($keys)->toHaveCount(60);
