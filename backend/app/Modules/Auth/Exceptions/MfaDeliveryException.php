...
/**
 * Raised when a second-factor code cannot be delivered, including when one was sent too recently.
 *
 * The reason varies by call site, so the call site names the message; the class
 * names the failure.
 */
class MfaDeliveryException extends RuntimeException implements LocalizableException
{
